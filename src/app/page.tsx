...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center p-6 relative">
      ...
      <Image src="/PS5.jpg" alt="Premio del sorteo" width={500} height={300} className="w-full max-w-xs sm:max-w-md lg:max-w-lg mt-6 rounded-lg shadow-lg" />
      ...
      <VerifyModal
        ...
        handleVerifyTickets={handleVerifyTickets}
        userInput={userInput}
      ...
      <div className="flex items-center mt-4">
        <button onMouseDown={() => startCounting(-1)} onMouseUp={stopCounting} onMouseLeave={stopCounting}>
          ➖
        </button>
      ...
      <button onClick={handlePurchase} className="mt-4 bg-orange-500 text-white px-6 py-2 rounded-lg hover:bg-orange-600">
        🛒 Comprar Ahora
      </button>

      <footer className="w-full mt-10 text-center text-gray-900 p-4">
        <p className="text-sm sm:text-base">📧 ventas@inversionesefaat.com | 📞 3014123951</p>
